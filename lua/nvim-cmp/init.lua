  ...
  mapping = {
    ...
    ["<Tab>"] = cmp.mapping(function(_)
      ...
      elseif luasnip.expand_or_jumpable() then
        ...
        require("modules.indent").smart_indent()
      end
    end, {
      "i",
      "s",
...
events.nvim_create_autocmd { "FileType", "markdown", "lua require'cmp'.setup.buffer { sources = {{ name = 'emoji' }}}" }
events.nvim_create_autocmd { "FileType", "lua", "lua require'cmp'.setup.buffer { sources = {{ name = 'nvim_lua' }}}" }
