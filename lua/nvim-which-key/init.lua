...
local japanese_mappings = {
  ...
  c = {
    name = "+コンテナ",
    c = { "<cmd>DockerToolsToggle", "Docker ツール" },
    a = { "<cmd>AttachToContainer", "接続" },
    b = { "<cmd>BuildImage", "イメージをビルド" },
  },
  d = {
    name = "+診断",
  ...
  l = {
    name = "+LSP",
    a = { "<cmd>lua vim.lsp.buf.code_action()<cr>", "コード アクション" },
    A = { "<cmd>lua vim.lsp.buf.range_code_action()<cr>", "選択範囲でコード アクション" },
...
local mappings = {
  ...
  c = {
    name = "+コンテナ",
    c = { "<cmd>DockerToolsToggle", "Docker Tools" },
    a = { "<cmd>AttachToContainer", "Connect" },
    b = { "<cmd>BuildImage", "Build Image" },
  },
  d = {
    name = "+Diagnostics",
